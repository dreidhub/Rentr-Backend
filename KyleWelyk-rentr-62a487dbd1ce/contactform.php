...
if(!isset($_REQUEST['action'])){ ?>
  <form name="frmRegistration" method="post" action="" enctype="multipart/form-data" class="shown">
    <table border="0" align="center" class="demo-table">
      ...
      <?php if(!empty($success_message)) { ?>
        ...
        <?php if(!empty($error_message)) { ?>
          ...
          <tr>
            <td>Message:</td>
            <td><textarea rows="6" cols="60" class="demoInputBox" name="contactmessage" value="<?php if(isset($_POST['contactmessage'])) echo $_POST['contactmessage']; ?>" required></textarea>
            </td>
          </tr>
          <tr>
