...
$getEachProp = "SELECT house_prop.*, propertylocation.* FROM house_prop, propertylocation  WHERE propertylocation.propertyid = house_prop.propertyid AND house_prop.verified = 'true' LIMIT 0,8";
